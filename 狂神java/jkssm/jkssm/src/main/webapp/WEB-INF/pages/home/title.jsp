...
<head>
    ...
    <!-- 调用样式表 -->
    <link rel="stylesheet" rev="stylesheet" type="text/css" href="/jkssm/skin/default/css/default.css" media="all"/>
    <link rel="stylesheet" rev="stylesheet" type="text/css" href="/jkssm/skin/default/css/title.css" media="all"/>

	<script type="text/javascript" src="/jkssm/components/jquery-ui/jquery-1.2.6.js"></script>
	<script language="javascript" src="/jkssm/js/pngfix_map.js"></script>
	<script language="javascript" src="/jkssm/js/common.js"></script>
...
<script language="javascript">
	...
	function CustomTitle(){
		...
		Me.onmouseover = function(){document.getElementById('memo').style.background='url(/jkssm/skin/default/images/title/memo2.gif) no-repeat'};
		Me.onmouseout = function(){document.getElementById('memo').style.background='url(/jkssm/skin/default/images/title/memo.gif) no-repeat'};
		
		Loin.onmouseover = function(){document.getElementById('small_login').style.background='url(/jkssm/skin/default/images/title/small_login2.gif) no-repeat'};
		Loin.onmouseout = function(){document.getElementById('small_login').style.background='url(/jkssm/skin/default/images/title/small_login.gif) no-repeat'};
		
		Lout.onmouseover = function(){document.getElementById('small_login_out').style.background='url(/jkssm/skin/default/images/title/login_out2.gif) no-repeat left -55px;'};
		Lout.onmouseout = function(){document.getElementById('small_login_out').style.background='url(/jkssm/skin/default/images/title/login_out.gif) no-repeat'};
	}
	...
	function linkHighlightMenu(obj){
		...
		for(var i=0;i<links.length;i++){
			if(links[i].id.indexOf('topmenu')!=-1){
				links[i].style.background = 'url("/jkssm/skin/default/images/title/li_dot.gif1") no-repeat right 8px';
				links[i].style.color = '';
		...
		obj.style.background ='url("/jkssm/skin/default/images/title/button_bg.jpg") no-repeat';
		obj.style.color = "#fff";                                                                                                                                                                                                                                                   
...
//			alert((0-currLeft) <= maxOffset);
		...
		function logout(){
			return formSubmit("/jkssm/home.action", "_top");
		}
</script>
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
		<img src="/jkssm/skin/default/images/title/avataronline.gif" border="0" style="margin-top:-1px;"/>
		...
		<img src="/jkssm/skin/default/images/title/close.gif" border="0" />
	</div>

	<a id="memos"  style="cursor:pointer;" href="/jkssm/fmain.action" target="_top" title="点击切换到系统首页"><div id="memo" class="memo" title="点击切换到系统首页"></div></a>
...
<div class="headerBg">
	<div class="top_logo">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		<div class="titleDate" style="float:left;">2021-01-16</div>
	    		<div style="height:29px;">
		    		<span id="leftKey"  onmouseover="periodOffset(this, 'left')"><img src="/jkssm/skin/default/images/title/left_arrow.png"/></span>
...
onclick="top.leftFrame.location.href='sysadminLeft.action';top.main.location.href='sysadminMain.action';linkHighlightMenu(this);">系统管理</span></div>
					...
					<span id="rightKey" onmouseover="periodOffset(this, 'right')"><img src="/jkssm/skin/default/images/title/right_arrow.png"/></span>
				</div>
		</div>
	</div>
</div>

<div id="prompt_div"><img src="/jkssm/skin/default/images/title/prompt.png"/><span style="position:absolute;top:2px;left:35px;z-index: 99999;width:100%;color:#FFFFFF;text-align: left; ">鼠标指向箭头位置<br/>可显示更多菜单项</span></div>
